...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, default='MaskCorrectDataset', help='dataset augmentation type (default: MaskSplitByProfileDataset)')
    ...
    parser.add_argument('--model_dir', type=str, default=os.environ.get('SM_MODEL_DIR', './model/mask'))
